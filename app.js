// FounderStack - Interactive JavaScript for Startup Founders (No Blur Version)
...
// Scroll Animations with Intersection Observer (No Blur Effects)
function initScrollAnimations() {
    ...
    const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                // Stagger animations for card grids (no blur)
    ...
    // Set initial styles without blur and observe elements
    ...
    // Initialize tech icons without blur
...
// Tooltip system (Optimized for Performance)
...
function initLinkTracking() {
    ...
    externalLinks.forEach(link => {
        link.addEventListener('click', function() {
            ...
            } else if (this.href.includes('network.grahammiranda.com')) {
...
// Add custom CSS animations (No Blur)
...
.btn, .stack-card, .tool-item, .infra-card {
